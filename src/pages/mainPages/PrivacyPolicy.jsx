...
export default () => (
  <React.Fragment>
    <div className="privacyPolicyPage">
      ...
      <p>
        Begge advokatene er behandlingsansvarlig for de personopplysninger vi behandler i forbindelse med bruk av våre nettsider og tjenester, eller når du kommer i kontakt med oss på annen måte.
      </p>
      <h2>
        4. Hvilke personopplysninger behandler vi?
      </h2>
      <p>
        Vi behandler blant annet opplysninger som navn, postadresse e-postadresse, telefonnummer, fødselsnummer, kredittopplysninger, IP-adresser.  Det er frivillig å gi oss tilgang til dine personopplysninger. I enkelte tilfeller vil vi imidlertid kunne trenge slik informasjon for å levere avtalte tjenester, kontakte deg, mv.
      </p>
      <h2>
        5. Hva bruker vi personopplysningene til?
      </h2>
      <p>
        Vi behandler personopplysninger ved håndtering av våre klientoppdrag, herunder ved fakturering, samt ved annen administrering av klientforholdet. Vi behandler også personopplysninger i jobbsøknadsprosesser, og til utsendelse av nyhetsbrev eller annet markedsføringsmateriell. De opplysninger vi samler inn for ovennevnte formål inkluderer både opplysninger du selv oppgir som for eksempel vår klient. Vi samler ikke informasjonen ved bruk av våre nettsider.
      </p>
      <h2>
      ...
      <p>
        Personvernreglene gir deg en rekke rettigheter, herunder rett til innsyn, retting og sletting i de personopplysningene vi har lagret på deg. Ved innføringen av EUs forordning for personvern vil du ha rett til dataportabilitet. Dette innebærer at du blant annet får mulighet til å ta med deg dine personopplysninger i et maskinlesbart format.  Du har videre rett til å motsette deg behandling av personopplysninger og rett til å motsette deg personprofilering og automatiserte avgjørelser. Når det gjelder kravet om sletting er det et unntak for de opplysninger som er nødvendig for at vi skal kunne levere en tjeneste som du fremdeles ønsker å ha tilgang til, eller det er lovpålagt å oppbevare opplysningene i en spesifikk periode.
      </p>
      <h2>
        10. Vår bruk av informasjonskapsler (cookies)
      </h2>
      <p>
        Vi bruker ikke informasjonskapsler (cookies) til å loggføre bruken av vår hjemmeside advokatdrammen.no.
      </p>
      <h2>
        11. Kontakt oss
      </h2>
      <p>
        Send oss gjerne en e-post til <a href="mailto:post@advokatdrammen.no">advokatdrammen.no</a> hvis du har spørsmål til hvordan vi behandler personopplysninger eller ønsker å be om innsyn, retting eller sletting mv.
      </p>
    </div>
  </React.Fragment>
);
