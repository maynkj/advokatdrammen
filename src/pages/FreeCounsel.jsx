...
export default () => (
  <React.Fragment>
    ...
    <p>
      For fri rettshjelp gjelder inntektsgrenser. For å få fri rettshjelp kan klienten ikke ha bruttoinntekt over kr. 246.000 for enslige og kr. 369.000 for ektefeller eller andre som lever sammen med felles økonomi. Formuesgrensen er kr 100.000. De økonomiske vilkårene for innvilgelse av fri rettshjelp følger av forskrift til lov om fri rettshjelp som ligger på lovdata. På <a href="http://www.lovdata.no/Drift-av-advokatvirksomhet/ Klientforholdet/Rettshjelpsforsikring/">lovdata.no</a> kan man også gratis søke i alle Norges lover og forskrifter.
    </p>
    <p>
